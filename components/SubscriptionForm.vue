<template>
  ...
  >
    <div class="flex flex-row space-x-2 w-full">
      ...
      />
      <span id="subscription-hint" class="sr-only">Enter a valid email address to subscribe to the newsletter</span>
      ...
      <input
        ...
        type="submit"
        value="Subscribe"
        aria-label="Subscribe to the Good First Issue newsletter"
      />
    </div>
  </form>
</template>