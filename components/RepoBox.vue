<template>
  <div
    ...
    class="select-none border w-full rounded-md mb-4 cursor-pointer transition-colors duration-150 hover:bg-ink-300 group focus-visible:outline focus-visible:ring-2 focus-visible:ring-juniper focus-visible:ring-offset-2 focus-visible:ring-offset-ink-400"
