...
**Good First Issue** is an initiative to curate easy picking from popular projects, so developers who've never contributed to open-source can get started quickly.
