...
**Good First Issue** is an initiative to curate easy starter tasks from popular projects, helping developers who have never contributed to open source get started quickly.

Open-source maintainers are always looking to involve more people, but new developers often find it challenging to become a contributors. We believe that helping developers fix super-easy issues removes the barrier to future contributions. This is why Good First Issue exists.
